...
if ($urgencia) {
    ...
    echo json_encode(['respuesta'=>"En este momento le estamos conectando con un asesor especializado que revisará su caso. Por favor espere un momento.

*Tododrogas, siempre a su servicio.*",'accion'=>'ESCALADO','resumen'=>$resumen,'fase'=>'escalado','intentos'=>$intentos]);
    exit;
}
...
if ($pideAsesor) {
    ...
    echo json_encode(['respuesta'=>"Con gusto, *$pn*. En este momento le conectamos con un asesor especializado. Por favor espere un momento.
...
if ($enojado) {
    ...
    if ($intentos >= 2) {
        ...
        echo json_encode(['respuesta'=>"Lamentamos los inconvenientes presentados, *$pn*. En este momento le conectamos con un asesor especializado que atenderá su caso de forma prioritaria.
...
if ($respondeSiAsesor && $intentos >= 1) {
    ...
    $resumen = generarResumen($histGPT, $nombre, $eps);
    escalar($telefono, $resumen);
    echo json_encode(['respuesta'=>"Perfecto, *$pn*. En este momento le conectamos con un asesor especializado. Por favor espere un momento.
